  ...
  const handleResendLink = async () => {
    ...
    try {
      ...
      if (error) {
        ...
        setMessage({
          type: 'error',
          text: error.message || 'Failed to send new magic link'
        })
      } else {
        setMessage({
          type: 'success',
          text: 'New magic link sent! Check your inbox and spam folder.'
        })
      ...
      setMessage({
        type: 'error',
        text: 'Failed to send new magic link. Please try again.'
      })
    } finally {
